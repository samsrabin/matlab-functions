function [ax,hfill]=cbarf_ssr(v, L, mode, scale, ...
    h_in, cmap);
...
%
%   SSR: See http://www.mathworks.com/matlabcentral/fileexchange/14290-cbarf
%   SSR: Added ability to specify:
%           - Axis to draw on (h_in)
%           - Color map (cmap)
%
%   Syntax:
...
if exist('h_in', 'var') && ~isempty(h_in)
    ax0 = h_in;
else
    ax0=gca;
end
